...
const u8 gText_Frame[] = _("Text frame");
const u8 gText_OptionMenuCancel[] = _("Save and quit");
...
const u8 gText_BattleSceneOn[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Show");
const u8 gText_BattleSceneOff[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Hide");
...
const u8 gText_Attack[] = _("Attach");
